...
fn main() {
    ...
    benchmark_v2(
        ...
        &iters,
        "../benchmark_outputs/sha3_chain_sp1.csv",
        "iters",
    );
    ...
    benchmark_v2(
        benchmark_sha2,
        &lengths,
        "../benchmark_outputs/sha2_sp1.csv",
        "byte length",
    );
    benchmark_v2(
        benchmark_sha3,
        &lengths,
        "../benchmark_outputs/sha3_sp1.csv",
        "byte length",
    );
    ...
    benchmark_v2(
        bench_tendermint,
        &values,
        "../benchmark_outputs/tendermint_sp1.csv",
        "block",
    );
    ...
    benchmark_with_shard_size(
        ...
        &iters,
        &shard_sizes,
        "../benchmark_outputs/sha2_chain_sp1_1_shard.csv",
        "iters",
    );
    ...
    benchmark_with_shard_size(
        ...
        &iters,
        &shard_sizes,
        "../benchmark_outputs/sha2_chain_sp1_2_shard.csv",
        "iters",
    );
    ...
    benchmark_with_shard_size(
        ...
        &iters,
        &shard_sizes,
        "../benchmark_outputs/sha2_chain_sp1_4_shard.csv",
        "iters",
    );
    ...
    benchmark_with_shard_size(
        ...
        &iters,
        &shard_sizes,
        "../benchmark_outputs/sha2_chain_sp1_8_shard.csv",
        "iters",
    );
    ...
    benchmark_with_shard_size(
        ...
        &iters,
        &shard_sizes,
        "../benchmark_outputs/sha2_chain_sp1_16_shard.csv",
        "iters",
    );
}
